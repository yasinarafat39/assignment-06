        ...
        <div class="card mb-3 shadow-sm">
            ...
            <div class="row g-0">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">${singleNews.details.length > 100 ?singleNews.details.slice(0, 400) + "..." : details}</p>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small>${singleNews.author.published_date}</small>
                            </div>
                        </div>
                        <p class="mt-0 mb-0"> <i class="fa-regular fa-eye"></i> ${singleNews.total_view}</p>
                        <!-- Button trigger modal -->
                        <i onclick="showDetailsOfNews('${singleNews._id}')" style='font-size:24px' class='far' role="button" data-bs-toggle="modal" data-bs-target="#newsDetailsModal">&#xf35a;</i>
                    </div>
                </div>
            </div>
            </div>
